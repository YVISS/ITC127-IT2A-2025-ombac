...
<body>
    ...
    <h3>
        <?php echo "Description: This program shows on how to process forms with radio buttons in HTML using php"; ?>
    </h3>
    <form action="" method="GET">
        Input Number: <input type="text" name="txtinput1"><br>
        Input Number: <input type="text" name="txtinput2"><br>
        <input type="radio" name="rboperation" value="Add" checked>Add<br>
        <input type="radio" name="rboperation" value="Subtract">Subtract<br>
        <input type="radio" name="rboperation" value="Multiply">Multiply<br>
        <input type="radio" name="rboperation" value="Divide">Divide<br>
