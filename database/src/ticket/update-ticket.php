                    ...
                    <div class="form">
                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . "?ticketnumber=" . $_GET['ticketnumber']); ?>" method="POST">
                            <div class="form__ticketnumber">
                                <h2>Ticket Number</h2>
                                <input type="text" id="ticketnumber" name="ticketnumber" value="<?php echo $ticket['ticketnumber']; ?>" readonly>
                            </div>
                            ...
                            <div class="form__status">
                                ...
                                <select name="cmbstatus" required>
                                    ...
                                    <option value="ONGOING" <?php echo ($ticket['status'] == 'ONGOING') ? 'selected' : ''; ?>>On-Going</option>
                                    <option value="FOR APPROVAL" <?php echo ($ticket['status'] == 'FOR APPROVAL') ? 'selected' : ''; ?>>For Approval</option>
                            ...
                            <div class="form__details">
                                <h2>Details</h2>
                                <textarea name="txtdetails" placeholder="Enter problem details..." required rows="15" cols="45"><?php echo $ticket['details']; ?></textarea>
                            </div>
